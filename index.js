...
async function init(ontologyLocation, configObject){
    ...
    schemaObj.rootResolver = new Resolver(schemaObj.database, schemaObj.Warnings, schemaObj.schemaMapping, schemaSDL).rootResolver; // Generate Resolvers for graphql
